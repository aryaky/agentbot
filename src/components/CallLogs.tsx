...
const logs = [
  { id: 'LOG-4821', type: '呼出', bot: 'Aria', customer: '+1 (555) 012-3456', duration: '4:12', sentiment: '正面', date: '3月30日, 14:05' },
  { id: 'LOG-4820', type: '呼入', bot: 'Leo', customer: '+1 (555) 012-7890', duration: '2:45', sentiment: '中性', date: '3月30日, 13:58' },
  { id: 'LOG-4819', type: '呼出', bot: 'Aria', customer: '+1 (555) 012-1122', duration: '1:12', sentiment: '负面', date: '3月30日, 13:42' },
  { id: 'LOG-4818', type: '呼出', bot: 'Nova', customer: '+1 (555) 012-3344', duration: '0:45', sentiment: '正面', date: '3月30日, 13:30' },
  { id: 'LOG-4817', type: '呼入', bot: 'Aria', customer: '+1 (555) 012-5566', duration: '5:24', sentiment: '正面', date: '3月30日, 13:15' },
  { id: 'LOG-4816', type: '呼出', bot: 'Leo', customer: '+1 (555) 012-7788', duration: '3:10', sentiment: '中性', date: '3月30日, 13:02' },
];
  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">通话日志</h2>
          <p className="text-brand-text-muted text-sm mt-1">所有语音互动的详细历史记录。</p>
        </div>
      ...
      <div className="glass-card">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-white/5 text-brand-text-muted text-xs uppercase tracking-wider">
                ...
                <th className="px-6 py-4 font-semibold">机器人</th>
                ...
                <tr key={log.id} className="hover:bg-white/5 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-sm">
                    <span className={`text-xs font-medium ${
                      log.sentiment === '正面' ? 'text-green-400' : 
                      log.sentiment === '中性' ? 'text-brand-text-muted' : 'text-red-400'
                    }`}>
                      {log.sentiment}
                    </span>
                  </td>
        ...
        <div className="p-4 border-t border-brand-border flex items-center justify-between text-sm text-brand-text-muted font-medium">
          <p>显示 1,284 条日志中的 6 条</p>
          <div className="flex items-center gap-2">
            <button className="px-3 py-1 bg-brand-bg border border-brand-border rounded hover:bg-white/5 disabled:opacity-50" disabled>上一页</button>
            <button className="px-3 py-1 bg-brand-bg border border-brand-border rounded hover:bg-white/5">下一页</button>
          </div>
        </div>
      </div>
    </div>
